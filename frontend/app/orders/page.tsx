  ...
  async function handleRequestSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (requestType === 'return') {
        ...
        const res = await fetch(`http://localhost:3001/api/orders/${selectedOrder?.id}/return-request`, {
          method: 'POST',
        ...
        const res = await fetch(`http://localhost:3001/api/orders/${selectedOrder?.id}/cancel`, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` },
          body: JSON.stringify({
