...
export default function MarketingPage() {
  ...
  const fetchMarketingData = async () => {
    ...
    try {
      ...
      // Fetch campaigns
      const campaignsRes = await fetch('http://localhost:3001/api/marketing/campaigns', {
        headers: token ? { Authorization: `Bearer ${token}` } : {},
      });
      
      // Fetch discounts
      const discountsRes = await fetch('http://localhost:3001/api/marketing/discounts', {
        headers: token ? { Authorization: `Bearer ${token}` } : {},
      });
      
      // Fetch automation rules
      const automationRes = await fetch('http://localhost:3001/api/marketing/automation', {
        headers: token ? { Authorization: `Bearer ${token}` } : {},
      });
      ...
      try {
        const templatesRes = await fetch('http://localhost:3001/api/marketing/templates', {
          headers: token ? { Authorization: `Bearer ${token}` } : {},
        });
  ...
  const handleCreateCampaign = async () => {
    try {
      const token = sessionStorage.getItem("admin_jwt");
      const response = await fetch('http://localhost:3001/api/marketing/campaigns', {
        method: 'POST',
        headers: {
  ...
  const handleCreateDiscount = async () => {
    try {
      const token = sessionStorage.getItem("admin_jwt");
      const response = await fetch('http://localhost:3001/api/marketing/discounts', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          ...(token ? { Authorization: `Bearer ${token}` } : {})
  ...
  const handleCreateAutomation = async () => {
    try {
      const token = sessionStorage.getItem("admin_jwt");
      const response = await fetch('http://localhost:3001/api/marketing/automation', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          ...(token ? { Authorization: `Bearer ${token}` } : {})
  ...
  const handleSendCampaign = async (campaign: Campaign) => {
    ...
    try {
      const token = sessionStorage.getItem("admin_jwt");
      const response = await fetch(`http://localhost:3001/api/marketing/campaigns/${campaign.id}/send`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          ...(token ? { Authorization: `Bearer ${token}` } : {})
  ...
  const handleUpdateCampaign = async () => {
    ...
    try {
      const token = sessionStorage.getItem("admin_jwt");
      const response = await fetch(`http://localhost:3001/api/marketing/campaigns/${selectedCampaign.id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          ...(token ? { Authorization: `Bearer ${token}` } : {})
  ...
  const handleDeleteDiscount = async (discount: Discount) => {
    ...
    try {
      const token = sessionStorage.getItem("admin_jwt");
      const response = await fetch(`http://localhost:3001/api/marketing/discounts/${discount.id}`, {
        method: 'DELETE',
        headers: {
          ...(token ? { Authorization: `Bearer ${token}` } : {})
        }
  ...
  const handleUpdateDiscount = async () => {
    ...
    try {
      const token = sessionStorage.getItem("admin_jwt");
      const response = await fetch(`http://localhost:3001/api/marketing/discounts/${selectedDiscount.id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          ...(token ? { Authorization: `Bearer ${token}` } : {})
  ...
  const handleUpdateAutomation = async () => {
    ...
    try {
      const token = sessionStorage.getItem("admin_jwt");
      const response = await fetch(`http://localhost:3001/api/marketing/automation/${selectedAutomation.id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          ...(token ? { Authorization: `Bearer ${token}` } : {})
  ...
  const handleCreateTemplate = async () => {
    try {
      const token = sessionStorage.getItem("admin_jwt");
      const response = await fetch('http://localhost:3001/api/marketing/templates', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          ...(token ? { Authorization: `Bearer ${token}` } : {})
  ...
  const handleUpdateTemplate = async () => {
    ...
    try {
      const token = sessionStorage.getItem("admin_jwt");
      const response = await fetch(`http://localhost:3001/api/marketing/templates/${selectedTemplate.id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          ...(token ? { Authorization: `Bearer ${token}` } : {})
